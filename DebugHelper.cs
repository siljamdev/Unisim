...
static class Examples{
	...
	public static readonly Particle[] solaraSystem = new Particle[] {
		// Star: Solara
		new Particle(new Vector2(0f, 0f), 1500f, new Color3("FFCC00")),
		// Inferno
		new Particle(new Vector2(4000f, 0f), new Vector2(0f, -25.0f), 4.5f, new Color3("FF4500")),
		// Veona
		new Particle(new Vector2(12000f, 0f), new Vector2(0f, -15.0f), 9.8f, new Color3("FFD700")),
		// Xaros
		new Particle(new Vector2(21000f, 0f), new Vector2(0f, -10.0f), 15f, new Color3("8A2BE2")),
		// Eryndor (earth like)
		new Particle(new Vector2(35000f, 0f), new Vector2(0f, -8.5f), 11f, new Color3("228B22")),
		// Aether
		new Particle(new Vector2(42000f, 0f), new Vector2(0f, -6.0f), 7.4f, new Color3("A9A9A9")),
		// Ares
		new Particle(new Vector2(55000f, 0f), new Vector2(0f, -3.5f), 10f, new Color3("DC143C")),
		// Phantoma
		new Particle(new Vector2(69000f, 0f), new Vector2(0f, -6.2f), 30.2f, new Color3("00BFFF")),
		// Jaemus
		new Particle(new Vector2(90000f, 0f), new Vector2(0f, -4.5f), 120f, new Color3("DAA520")),
		// Kaela (moon)
		new Particle(new Vector2(91000f, 0f), new Vector2(0f, -7.9f), 6.5f, new Color3("F0F8FF")),
		// Zorath
		new Particle(new Vector2(130000f, 0f), new Vector2(0f, -4.8f), 13f, new Color3("FF6347")),
		// Zythra
		new Particle(new Vector2(160000f, 0f), new Vector2(0f, -4.2f), 5.6f, new Color3("A52A2A")),
		// Ceres
		new Particle(new Vector2(210000f, 0f), new Vector2(0f, -2.8f), 20f, new Color3("B0C4DE"))
	};
	...
	public static readonly Particle[] test = new Particle[]{
		Particle.Tark.translate(-3, -3),
		Particle.Mark.translate(3, -3),
		Particle.Mark.translate(3, 3),
		Particle.Tark.translate(-3, 3)
	};
	...
	public static Particle[] RPF{
		get{			
			return RPFparams(100, 700, 100f, 0.5f, 30, 30, 30, 5, 5);
		}
	}
	
	public static Particle[] RPFparams(int mnum, int xnum, float size, float vel, int wb, int wm, int wt, int wc, int wp){
		...
		for (int i = 0; i < n; i++){
			...
			//float vx = random(r, -velocity, velocity);
			//float vx = random(r, -velocity, velocity);
			Vector2d v = Vector2d.Normalize(newParticle.position);
